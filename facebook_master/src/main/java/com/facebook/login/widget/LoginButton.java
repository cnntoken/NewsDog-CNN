...
public class LoginButton extends FacebookButtonBase {
    ...
    protected void configureButton(
        ...
        setButtonText();
//        int indentify = getResources().getIdentifier("com_facebook_button_login_logo","drawable","com.facebook");
        ...
        setCompoundDrawablesWithIntrinsicBounds(
                getResources().getDrawable(R.drawable.com_facebook_button_login_logo),
            null,
            null,
            null);
    }
