...
import com.videolibrary.visibility.scroll.ScrollDirectionDetector;
...
public abstract class BaseItemsVisibilityCalculator implements ListItemsVisibilityCalculator {
    ...
    public void onScrolled(int scrollState) {
        ...
        switch (scrollState) {
            case AbsListView.OnScrollListener.SCROLL_STATE_TOUCH_SCROLL:
                onStateTouchScroll(scrollState,mPositionGetter);
                break;
    ...
    protected abstract void onStateTouchScroll(int state, ItemsPositionGetter itemsPositionGetter);
