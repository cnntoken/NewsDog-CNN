package com.videolibrary.visibility.calculator;

import android.util.Log;
import android.view.View;
import android.widget.AbsListView;

import com.videolibrary.visibility.items.ListItem;
import com.videolibrary.visibility.items.ListItemData;
import com.videolibrary.visibility.scroll.ItemsPositionGetter;
import com.videolibrary.visibility.scroll.ItemsProvider;
...
public class SingleListViewItemActiveCalculator extends BaseItemsVisibilityCalculator {
     ...
     */
    @Override
    protected void onStateTouchScroll(int scrollState, ItemsPositionGetter itemsPositionGetter) {
        // 滚动停止时才开始计算, 避免在滚动时消耗资源
